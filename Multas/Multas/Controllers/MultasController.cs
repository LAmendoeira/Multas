...
namespace Multas.Controllers
{
    public class MultasController : Controller
    {
        ...
        {
            //Obtem uma lista de multas emitidas
        ...
        public ActionResult Details(int? id)
        {
            ...
            Models.Multas multas = db.Multas.Find(id);
            if (multas == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "ID,LocalDaMulta,Infracao,DataDaMulta,ValorMulta,AgenteFK,CondutorFK,ViaturaFK")] Models.Multas multas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,LocalDaMulta,Infracao,DataDaMulta,ValorMulta,AgenteFK,CondutorFK,ViaturaFK")] Models.Multas multas)
        {
            if (ModelState.IsValid)
            {
